 ...
 *
 * @author noblemaster http://blog.noblemaster.com/2010/08/19/color-swatch-color-selector-for-java/
...
public class ColorSelector extends JButton {
  ...
  public ColorSelector() {
    this(Color.BLACK, getDefaultColors());
  }
      ...
      public void actionPerformed(ActionEvent arg0) {
        ...
        swatch.addColorListener(new ColorSwatch.ColorListener() {
          public void handleColor(Color color) {
            ...
            actionPropertyChanged(getAction(), "ColorChanged");
          }
        });
        popup.add(swatch);
